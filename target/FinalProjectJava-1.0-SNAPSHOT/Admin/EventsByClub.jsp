...
<div class="col-md-8 col-sm-9 col-xs-12">
    ...
    <div class="feed-block">
        ...
        <c:forEach var="events" items="${eventsByClubs}">
            <form method="post" action="<%=request.getContextPath()%>/ServletUpdateEvents">
                ...
                <div class="row">
                    <div class="col-12">
                        <button class="btn btn-primary" type="submit" name="update" value="${events.id}" style="width: 100%">Update</button>
                    </div>
                </div>
            </form>
                <div class="row">
                    <div class="col-12">
                        <form method="post" action="<%=request.getContextPath()%>/ServletDeleteEvents">
                            <td><button class="btn btn-primary" type="submit" name="delete" value="${events.id}" style="width: 100%">Delete</button></td>
                        </form>
                    </div>
                </div>
            <hr>
...
<div class="col-md-4 col-sm-12 col-xs-12">
    <div class="nav-bar">
        ...
        <form method="post" action="<%=request.getContextPath()%>/ServletCreateEvents">
            <p>Title:</p>
