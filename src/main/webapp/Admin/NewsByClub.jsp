            ...
            <form method="post" action="<%=request.getContextPath()%>/ServletUpdateNews">
                ...
                <div class="row">
                    <div class="col-12" style="text-align: center">
                        <button class="btn btn-primary" type="submit" name="update" value="${news.id}"  style="width: 100%">Update</button>
                    </div>
                </div>
            </form>
                <div class="row">
                    <div class="col-12" style="text-align: center">
                        <form method="post" action="<%=request.getContextPath()%>/ServletDeleteNews">
                            <button class="btn btn-primary" type="submit" name="delete" value="${news.id}" style="width: 100%">Delete</button>
                        </form>
                    </div>
                </div>
            <hr>
...
<div class="col-md-4 col-sm-12 col-xs-12">
    <div class="nav-bar">
        ...
        <form method="post" action="<%=request.getContextPath()%>/ServletCreateNews">
            ...
            <button class="btn btn-primary" type="submit" name="create" style="width: 100%">Create</button>
        </form>
    </div>
</div>
